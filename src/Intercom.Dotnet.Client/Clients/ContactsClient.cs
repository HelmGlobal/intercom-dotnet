...
namespace Intercom.Clients
{
	public class ContactsClient : Client
	{
		...
		public ContactsClient(Authentication authentication, HttpClientHandler handler)
			: base(INTERCOM_API_BASE_URL, CONTACTS_RESOURCE, authentication, handler)
		{ }
		...
		public ContactsClient(String intercomApiUrl, Authentication authentication, HttpClientHandler handler)
			: base(String.IsNullOrEmpty(intercomApiUrl) ? INTERCOM_API_BASE_URL : intercomApiUrl, CONTACTS_RESOURCE, authentication, handler)
		{ }
