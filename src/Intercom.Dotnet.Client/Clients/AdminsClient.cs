...
namespace Intercom.Clients
{
	public class AdminsClient : Client
	{
		...
		public AdminsClient(Authentication authentication, HttpClientHandler handler)
			: base(INTERCOM_API_BASE_URL, ADMINS_RESOURCE, authentication, handler)
		{ }
		...
		public AdminsClient(String intercomApiUrl, Authentication authentication, HttpClientHandler handler)
			: base(String.IsNullOrEmpty(intercomApiUrl) ? INTERCOM_API_BASE_URL : intercomApiUrl, ADMINS_RESOURCE, authentication, handler)
		{ }
